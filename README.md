...
Hyprpm is a tool integrated with the latest Hyprland version, to use it first you'll need to add the repository and then enable the plugin. The plugin builds with `meson`, so make sure you install that first.
